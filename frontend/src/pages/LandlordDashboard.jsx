...
  // 🛑 CHANGE 1: Simplified normalization. Since the API only returns owned properties,
  // we explicitly set is_owned to 1 to avoid relying on a non-existent field.
...
                    }}>{p.status}</span>
                    {/* 🛑 CHANGE 2: Removed redundant conditional check (p.is_owned === 1) */}
